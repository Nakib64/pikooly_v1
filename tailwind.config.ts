  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "cart-teal": "hsl(var(--cart-teal))",
        "cart-teal-dark": "hsl(var(--cart-teal-dark))",
        "cart-delivery": "hsl(var(--cart-delivery))",
        "cart-addon": "hsl(var(--cart-addon))",
        "cart-addon-border": "hsl(var(--cart-addon-border))",
      ...
      animation: {
        ...
        "slide-out-right": "slide-out-right 0.4s cubic-bezier(0.65,0,0.35,1)",
      ...
      backgroundImage: {
        ...
        "gradient-radial-luxe": "var(--gradient-radial-luxe)",
      },
      boxShadow: {
